...
# [GCC 6.3.0 20170118]
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\device_parameter_bank.py
...
class MaxDeviceParameterBank(DeviceParameterBank):
    ...
    def _collect_parameters(self):
        ...
        parameters = [ parameters[index] if 1 else None for index in indices if index >= 0 ]
