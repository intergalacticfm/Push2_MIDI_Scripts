...
# [GCC 6.3.0 20170118]
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\browser_component.py
...
class BrowserComponent(CompoundComponent, Messenger):
    ...
    def _update_navigation_buttons(self):
        ...
        if self.context_color_index > -1:
            context_button_color = IndexedColor.from_live_index(self.context_color_index, DISPLAY_BUTTON_SHADE_LEVEL) if 1 else 'Browser.Navigation'
