...
# [GCC 6.3.0 20170118]
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\quantization_component.py
...
class QuantizationSettingsComponent(Component):
    ...
    quantize_amount = listenable_property.managed(0.44)
