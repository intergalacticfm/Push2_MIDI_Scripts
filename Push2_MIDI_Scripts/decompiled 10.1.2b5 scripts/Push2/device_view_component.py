...
# [GCC 6.3.0 20170118]
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\Push2\device_view_component.py
...
class DeviceViewConnector(Component):
    ...
    def update(self):
        ...
        if parameter_infos != self._parameter_infos:
            ...
            self._view.parameters = [ get_view_parameter(info.parameter, info.name) if 1 else None for info in parameter_infos if info
                                    ]
        return
