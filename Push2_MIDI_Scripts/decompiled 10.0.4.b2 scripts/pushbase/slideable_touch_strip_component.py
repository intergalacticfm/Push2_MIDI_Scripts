...
# [GCC 6.3.0 20170118]
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\slideable_touch_strip_component.py
...
class SlideableTouchStripComponent(Component):
    ...
    def _update_touch_strip_array(self, num_leds):
        if self.is_enabled():
            ...
            array = [ TouchStripStates.STATE_HALF if 1 else TouchStripStates.STATE_OFF for i in xrange(num_leds) if led_contents(i)
                    ]
