...
# [GCC 6.3.0 20170118]
# Embedded file name: c:\Jenkins\live\output\win_64_static\Release\python-bundle\MIDI Remote Scripts\pushbase\touch_strip_controller.py
...
class TouchStripPitchModComponent(Component, Messenger):
    ...
    def _update_touch_strip_indication(self):
        if self._touch_strip_indication:
            ...
            self._touch_strip_indication.send_state([ TouchStripStates.STATE_FULL if 1 else TouchStripStates.STATE_HALF for _ in xrange(self._touch_strip_indication.state_count) if self.touch_strip_toggle.is_toggled
                                                    ])
