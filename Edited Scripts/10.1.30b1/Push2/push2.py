...
class Push2(IdentifiableControlSurface, PushBase):
    ...
    def _create_main_mixer_modes(self):
        ...
        routing_control = RoutingControlComponent(is_enabled=False, layer=Layer(monitor_state_encoder='parameter_controls_raw[0]', input_output_choice_encoder='parameter_controls_raw[1]', routing_type_encoder='parameter_controls_raw[2]', routing_channel_encoders=self.elements.global_param_controls.submatrix[
         3:7, :], routing_channel_position_encoder='parameter_controls_raw[7]'))
    ...
    def _create_clip_mode(self):
        ...
        self._clip_control.mode_selector.add_mode('midi', [
         make_freeze_aware(self._clip_control.midi_loop_controller, base_loop_layer + Layer(encoders=self.elements.global_param_controls.submatrix[1:4, :], zoom_encoder='fine_grain_param_controls_raw[0]')),
         self._clip_control.midi_clip_controller])
        self._clip_control.mode_selector.add_mode('audio', [
         make_freeze_aware(self._clip_control.audio_loop_controller, base_loop_layer + Layer(encoders=self.elements.global_param_controls.submatrix[1:4, :], zoom_encoder='fine_grain_param_controls_raw[0]')),
