...
BANK_DEFINITIONS = {'AudioEffectGroupDevice': RACK_BANKS,
   ...
   'ChannelEq': IndexedDict((
               (
                BANK_MAIN_KEY,
                {BANK_PARAMETERS_KEY: (
                                       'Highpass On', use('Low Gain').with_name('Low'),
                                       use('Mid Gain').with_name('Mid'), 'Mid Freq',
   ...
   'Delay': IndexedDict((
           (
            ...
            {BANK_PARAMETERS_KEY: (
                                   ...
                                   'Filter Freq', 'Filter Width', 'Feedback', 'Dry/Wet'),
               OPTIONS_KEY: (
                           '', '', '', 'Filter', '', 'Freeze', '')
               }),
           (
            ...
            {BANK_PARAMETERS_KEY: (
                                   ...
                                   'R Offset', 'Ping Pong', 'Feedback', 'Dry/Wet'),
               OPTIONS_KEY: (
                           'L Delay Sync', '', 'R Delay Sync', '', 'Delay Mode', 'Freeze', '')
               }),
           (
            'Filter/Mod',
            {BANK_PARAMETERS_KEY: (
                                   'Filter Freq', 'Filter Width', 'Mod Freq', 'Dly < Mod',
                                   'Filter < Mod', 'Ping Pong', 'Feedback', 'Dry/Wet'),
               OPTIONS_KEY: (
                           'Filter', '', '', '', '', 'Freeze', '')
               }))),
   'Tube': IndexedDict((
...
PARAMETERS_BLACKLIST_FOR_CPP_SANITY_CHECK = {'OriginalSimpler': (
   ...
   'InstrumentVector': (
                      ...
                      'MIDI Aftertouch Mod Amount', 'MIDI Mod Wheel Mod Amount', 'MIDI Random On Note On',
                      'Current Mod Target', 'Unison Mode', 'Unison Voices', 'Mono On', 'Poly Voices',
                      'Filter Routing'),
   'Echo': (
          'Channel Toggle',),
   'Delay': (
           'Channel', 'L Sync Enum', 'R Sync Enum', 'Link Switch')
   }